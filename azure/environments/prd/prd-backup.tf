...
# Postgres backups are configured inline on the instance (prd-postgres.tf,
# geo_redundant gated by enable_postgres_geo_backup, default on in prd).
# -----------------------------------------------------------------------------
