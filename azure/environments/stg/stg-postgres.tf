...
#
# Tiered up from dev: General Purpose D2s_v3 SKU, zone-redundant HA,
# 14-day backup retention. Geo-redundant backup gated by toggle (off
# by default in stg; flip on for prd).
# -----------------------------------------------------------------------------
